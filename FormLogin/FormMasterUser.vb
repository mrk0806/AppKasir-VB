...
Public Class FormMasterUser
    'membersihkan semua textbox dan combobox supaya kosong
    Sub kondisiAwal()
        TextBox1.Text = ""
    ...
    End Sub
    'tampilkan data dari db ke datagird
    Sub MunculGrid()
        Call koneksi2()
        ...
        DataGridView1.Columns(1).Width = 164
    ...
    End Sub
    'munculkan data dari db melalui textbox 1
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        ...
        End If
    End Sub
    'perintah untuk cari data berdasarkan username
    Private Sub TextBox4_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TextBox4.KeyPress
        ...
        End If
    End Sub
    'perintah untuk munculkan data dari DGV ke textbox
    ...
    Private Sub Button5_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button5.Click
        'Form1.ShowDialog()
        AxCrystalReport1.ReportFileName = "ReportAdmin.rpt"
